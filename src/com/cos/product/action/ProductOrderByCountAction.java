...
public class ProductOrderByCountAction implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Product> products = productRepository.orderByCount();
		String productsJson = gson.toJson(products);
		Script.outJson(productsJson, response);
		System.out.println("ProductOrderByCountAction : productsJson : " + productsJson);
	}
}
